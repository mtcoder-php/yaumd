        ...
        <div class="max-w-2xl mx-auto space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="field-label"><span class="req">*</span> Dars nomi</label>
                ...
                <!-- Turi -->
                <div>
                    <label class="field-label"><span class="req">*</span> Dars turi</label>
                ...
                <div v-if="form.type === 'scorm'" class="space-y-3 p-4 rounded-xl bg-gray-50 border border-gray-100">
                    ...
                    <div>
                        <label class="field-label"><span v-if="!lesson.scorm_package" class="req">*</span> {{ lesson.scorm_package ? "Yangi paket fayli (.zip)" : "Paket fayli (.zip)" }}</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <label class="flex items-center gap-2 text-sm text-gray-700 p-3 rounded-xl bg-gray-50 border border-gray-100">
                        <input type="checkbox" v-model="form.is_free" class="rounded accent-brand-600">
                        Bepul namuna sifatida ko'rsatish
                    </label>
                    <label class="flex items-center gap-2 text-sm text-gray-700 p-3 rounded-xl bg-gray-50 border border-gray-100">
                        <input type="checkbox" v-model="form.is_published" class="rounded accent-brand-600">
                        Nashr qilingan
                    </label>
                </div>
            </div>

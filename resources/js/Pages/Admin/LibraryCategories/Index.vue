    ...
    <AppLayout title="Kutubxona kategoriyalari">
        <div class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('admin.library-categories.create')" class="btn-brand">
                    ...
                    <tr v-for="c in categories" :key="c.id">
                        <td>
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl flex items-center justify-center text-white flex-shrink-0 bg-brand-600">
                        ...
                        <td>
                            <div class="flex items-center justify-end gap-1">
                                <Link :href="route('admin.library-categories.edit', c.id)" title="Tahrirlash" class="btn-ghost-icon">

    ...
    <AppLayout title="Kurs kategoriyalari">
        <div class="space-y-5">
            ...
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('admin.course-categories.create')" class="btn-primary">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden"
                ...
                <table class="w-full">
                    ...
                    <tr class="border-b border-gray-100">
                        ...
                        <th class="text-left px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Ota-kategoriya</th>
                        <th class="text-center px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Kurslar</th>
                        <th class="text-center px-4 py-3 text-xs font-semibold text-gray-400 uppercase tracking-wider">Tartib</th>
                    ...
                    <tr v-for="c in categories" :key="c.id" class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-center text-sm text-gray-600">{{ c.order }}</td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3">
                                <Link :href="route('admin.course-categories.edit', c.id)"

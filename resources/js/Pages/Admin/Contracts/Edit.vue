                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            >
                                <Icon :icon="s.icon" class="w-4 h-4"
                                      :style="form.status === s.value ? 'color:#0f3460' : 'color:#9ca3af'" />
                                <span class="text-sm font-semibold"
                                      :style="form.status === s.value ? 'color:#0f3460' : 'color:#374151'">
                                    {{ s.label }}
                                </span>
                                <Icon v-if="form.status === s.value" icon="mdi:check" class="w-4 h-4 ml-auto"
                                      style="color:#0f3460" />
                            </button>
                        </div>

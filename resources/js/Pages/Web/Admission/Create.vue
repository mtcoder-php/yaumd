    ...
    <WebLayout :settings="settings" :faculties="faculties">
        ...
        <div style="background: linear-gradient(135deg, #0f3460, #16213e, #533483)" class="py-12">
            <div class="container mx-auto px-4 text-center">
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-medium text-white/80 mb-4" style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2)">
                ...
                <div class="max-w-xl mx-auto">
                    ...
                    <div style="background:white; border-radius:1rem; border:1px solid #e5e7eb; box-shadow:0 2px 12px rgba(0,0,0,0.06)">
                        ...
                        <div v-if="currentStep === 1" class="p-6">
                            ...
                            <div class="flex flex-col gap-3">
                                <button
                                    ...
                                    :key="type.value"
                                    type="button"
                                    @click="form.education_type = type.value"
                                ...
                                >
                                    <div>
                                        ...
                                        <span class="text-xs ml-2" :style="form.education_type === type.value ? 'color:#0f3460' : 'color:#9ca3af'">
                                            ({{ type.desc }})
                                        </span>
                                    </div>
                        ...
                        <div v-if="currentStep === 2" class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select v-model="form.direction_id" class="field-input" :class="errors.direction_id ? 'field-error' : ''">
                                    ...
                                    <option v-for="d in allDirections" :key="d.id" :value="d.id">
                                        {{ d.name_uz }} — {{ d.degree === 'bachelor' ? 'Bakalavr' : 'Magistr' }}
                                    </option>
                                </select>
                                ...
                                <div class="flex flex-col gap-2.5 mt-1">
                                    ...
                                    >
                                        <div class="flex items-center gap-3">
                                            <Icon :icon="sf.icon" class="w-5 h-5" :style="form.study_form === sf.value ? 'color:#0f3460' : 'color:#9ca3af'" />
                                            <div class="text-left">
                                                <p class="text-sm font-semibold" :style="form.study_form === sf.value ? 'color:#0f3460' : 'color:#374151'">
                                                    {{ sf.label }}
                                                </p>
                                                <p v-if="sf.disabled" class="text-xs" style="color:#ef4444">Hozircha mavjud emas</p>
                                                <p v-else class="text-xs" style="color:#9ca3af">{{ sf.desc }}</p>
                                            </div>
                                        </div>
                        ...
                        <div v-if="currentStep === 3" class="p-6">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <input v-model="form.first_name" type="text" placeholder="Passportdagidek" class="field-input" :class="errors.first_name ? 'field-error' : ''">
                                ...
                                <div>
                                    ...
                                    <input v-model="form.last_name" type="text" placeholder="Passportdagidek" class="field-input" :class="errors.last_name ? 'field-error' : ''">
                                ...
                                <div>
                                    ...
                                    <input v-model="form.middle_name" type="text" placeholder="Passportdagidek" class="field-input" :class="errors.middle_name ? 'field-error' : ''">
                                    ...
                                    <div class="grid grid-cols-3 gap-3">
                                        <div>
                                            <input
                                                ...
                                                class="field-input"
                                                :class="errors.birth_year ? 'field-error' : ''"
                                            >
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex gap-6 mt-2">
                                        <label v-for="g in genders" :key="g.value" class="flex items-center gap-2 cursor-pointer">
                                            ...
                                            <div class="w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all"
                                                ...
                                                <div v-if="form.gender === g.value" class="w-2.5 h-2.5 rounded-full" style="background:#0f3460"></div>
                                            </div>
                        ...
                        <div v-if="currentStep === 4" class="p-6">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        maxlength="9"
                                        class="field-input"
                                        :class="errors.passport_series ? 'field-error' : ''"
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <select v-model="form.region_id" class="field-input" :class="errors.region_id ? 'field-error' : ''" @change="form.district_id = ''">
                                            <option value="">Tanlang</option>
                                    ...
                                    <div>
                                        <label class="field-label">Qaysi tuman yoki shaharsiz? <span class="req">*</span></label>
                                        <select v-model="form.district_id" class="field-input" :class="errors.district_id ? 'field-error' : ''" :disabled="!form.region_id">
                                            <option value="">Tanlang</option>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input v-model="form.phone" type="tel" placeholder="+998" class="field-input" :class="errors.phone ? 'field-error' : ''">
                                        <p v-if="errors.phone" class="err">{{ errors.phone }}</p>
                                    </div>
                                    <div>
                                        <label class="field-label">Qo'shimcha raqam</label>
                                        <input v-model="form.extra_phone" type="tel" placeholder="+998" class="field-input">
                                    </div>
                                </div>
                            ...
                            <!-- Diqqat -->
                            <div class="mt-4 p-3.5 rounded-xl flex items-start gap-2.5" style="background:#fff7ed; border:1px solid #fed7aa">
                                ...
                                <p class="text-xs leading-relaxed" style="color:#c2410c">
                                    <strong>DIQQAT!!!</strong> Doimiy aloqada bo'lgan telefon raqamingizni kiriting va qabul bo'yicha yuborilgan SMS kod va xabarnomalarni saqlab qo'ying
                                </p>
                            </div>
                        </div>

                        <!-- Footer -->
                        <div class="px-6 py-4 flex items-center justify-between" style="border-top:1px solid #f3f4f6; background:#fafafa; border-radius:0 0 1rem 1rem">
...
const educationTypes = [
    ...
    { value: 'second',   label: '2-mutaxassislik',        desc: 'Parallel diplom dasturi' },
]
...
const allDirections = computed(() =>
    props.faculties.flatMap(f => (f.directions || []))
)

...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'hemis_id'          => 'nullable|string|max:50|unique:students,hemis_id',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            $max = $this->maxCourseYear($this->input('degree'), $this->input('study_form'));
    ...
    public static function maxCourseYear(?string $degree, ?string $studyForm): int
    {
        if ($degree === 'master') {
            return 2;
        }

        return $studyForm === 'full_time' ? 4 : 5;
    }
}
